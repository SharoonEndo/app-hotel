...
var requestAnimationFrame = function requestAnimationFrame2(callback) {
  if (hasWindow) {
    ...
    callback((/* @__PURE__ */ new Date()).getTime());
    return null;
  }
};
...
var Map = function(_Component) {
  ...
  _proto.renderAttribution = function renderAttribution() {
    ...
    }, "Pigeon"), " | "), attribution || import_react.default.createElement("span", null, " © ", import_react.default.createElement("a", {
...
function Marker(props) {
  ...
  }, props.children || import_react.default.createElement("svg", {
    width,
    height,
    viewBox: "0 0 61 71",
    fill: "none",
...
function MultiLineString(props) {
  return import_react.default.createElement(import_react.default.Fragment, null, props.coordinates.map(function(line, i) {
    return import_react.default.createElement(LineString, _objectSpread2(_objectSpread2({}, props), {}, {
      coordinates: line,
      key: i
    }));
  }));
